...
const VARIANT_META: Record<string, {
  ...
  full: {
    title: 'Solana Monitor - Real-Time Solana Intelligence Dashboard',
    description: 'Real-time Solana blockchain dashboard with DeFi analytics, validator tracking, whale monitoring, token radar, AI-powered insights, and on-chain intelligence.',
    keywords: 'solana, defi, dashboard, token radar, whale tracker, validator map, jupiter, raydium, memecoin, pump.fun, solana monitor, on-chain analytics, crypto dashboard, SOL, DePIN, NFT, MEV, jito',
    url: 'https://solanamonitor.app/',
    siteName: 'Solana Monitor',
    features: [
      'Real-time token radar with rug detection',
      'Validator globe with stake distribution',
      'Whale wallet tracking & alerts',
      'AI-powered token briefs',
      'DeFi protocol analytics',
      'Jupiter swap integration',
      'Memecoin & pump.fun monitoring',
      'MEV & Jito analytics',
      'Network health & TPS tracking',
  ...
  return {
    ...
    transformIndexHtml(html) {
      return html
        ...
        .replace(/"name": "Solana Terminal"/, `"name": "${meta.siteName}"`)
        .replace(/"alternateName": "SolanaTerminal"/, `"alternateName": "${meta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/solanaterminal\.app\/"/, `"url": "${meta.url}"`)
        .replace(/"description": "Real-time Solana blockchain dashboard.*?"/, `"description": "${meta.description}"`)
...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Solana Terminal - Real-Time Solana Intelligence Dashboard',
        short_name: 'SolanaTerminal',
        description: 'AI-powered real-time Solana blockchain intelligence dashboard',
        start_url: '/',
        scope: '/',
        display: 'standalone',
        orientation: 'any',
