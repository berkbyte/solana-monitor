...
export const CRYPTO_IDS = ['bitcoin', 'ethereum', 'solana', 'jupiter-exchange-solana', 'jito-governance-token', 'bonk', 'dogwifcoin', 'pyth-network', 'raydium', 'marinade'] as const;
...
export const CRYPTO_MAP: Record<string, { name: string; symbol: string }> = {
  ...
  marinade: { name: 'Marinade', symbol: 'MNDE' },
};
