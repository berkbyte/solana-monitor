...
export class ETFFlowsPanel extends Panel {
  ...
  private renderPanel(): void {
    ...
    const solPriceStr = d.solPrice ? `SOL $${d.solPrice.toLocaleString()}` : '';
      ...
      <div class="etf-flows-container">
        <div class="etf-summary ${dirClass}">
          ...
          <div class="etf-summary-item">
            ...
            <span class="etf-summary-value ${s.totalEstFlow >= 0 ? 'flow-inflow' : 'flow-outflow'}">$${formatVolume(Math.abs(s.totalEstFlow))}</span>
          </div>
          <div class="etf-summary-item">
            <span class="etf-summary-label">${solPriceStr || 'Total Vol'}</span>
