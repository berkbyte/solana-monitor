...
// Full variant: Finance & crypto channels (24/7 live streams)
...
export class LiveNewsPanel extends Panel {
  ...
  private get embedOrigin(): string {
    try { return new URL(getRemoteApiBaseUrl()).origin; } catch { return 'https://solanaterminal.app'; }
  }
